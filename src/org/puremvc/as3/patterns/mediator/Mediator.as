...
package org.puremvc.as3.patterns.mediator
{
	...
	public class Mediator extends Notifier implements IMediator, INotifier
	{
		 ...
		 * Constructor.
		 */
		public function Mediator( aMediatorName:String=null, aViewComponent:Object=null ) {
			super();
			this.mediatorName = (aMediatorName != null)?aMediatorName:NAME; 
			this.viewComponent = aViewComponent;	
		}
