...
package org.puremvc.as3.core
{
	...
	public class Model implements IModel
	{
		...
		{
			proxyMap[ aProxy.getProxyName() ] = aProxy;
			aProxy.onRegister();
		}
		...
		{
			return proxyMap[ aProxyName ] != null;
		}
		...
		{
			var proxy:IProxy = (proxyMap [ aProxyName ]) as IProxy;
			if ( proxy ) 
			{
				proxyMap[ aProxyName ] = null;
				proxy.onRemove();
			}
			return proxy;
		}
		...
		// Message Constants
		protected static const SINGLETON_MSG	: String = "Model Singleton already constructed!";
